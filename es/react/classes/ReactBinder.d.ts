...
declare class ReactBinder<VM extends object> extends Binder<VM> {
    ...
    useBinding<P extends keyof VM & string, V = VM[P]>(propertyName: P, converter?: IConverter<VM[P], V>): [V, import("../../bindings/types").Dispatch<import("../../bindings/types").SetAction<V>>, import("../..").BindingContext];
